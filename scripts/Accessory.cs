...
function GetAccessoryList(%clientId, %type, %filter)
{
	...
	if(IsDead(%clientId) || !fetchData(%clientId, "HasLoadedAndSpawned") || %clientId.IsInvalid || %clientId.choosingGroup || %clientId.choosingClass || %clientId.choosingFirstClass)
		return "";
