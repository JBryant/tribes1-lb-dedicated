...
BeltItem::AddWeapon("Longsword", "Longsword", "Longsword", $SwordAccessoryType, $description, $SkillSwords, $SkillSwords @ " 90", "42", 18);
$description = "This sword has a broad and sturdy blade, but its iron construction makes it very heavy.";
BeltItem::AddWeapon("Iron Sword", "IronSword", "BroadSword", $SwordAccessoryType, $description, $SkillSwords, $SkillSwords @ " 200", "55", 19);
$description = "A sword forged from the metal known as mythril. Its brilliantly shining blade is incredibly lightweight.";
BeltItem::AddWeapon("Mythril Sword", "MythrilSword", "Shortsword", $SwordAccessoryType, $description, $SkillSwords, $SkillSwords @ " 250", "68", 20);
$description = "The handle of this single-edged sword has been decorated with intricate coral piecework.";
BeltItem::AddWeapon("Coral Sword", "CoralSword", "GemSword", $SwordAccessoryType, $description, $SkillSwords, $SkillSwords @ " 480", "80", 21);
$description = "The blade of this sword is a deep crimson, as if it were drenched in blood. It is cruelly sharp.";
BeltItem::AddWeapon("Blood Sword", "BloodSword", "Katana", $SwordAccessoryType, $description, $SkillSwords, $SkillSwords @ " 650", "92", 22);
$description = "A sword constructed using ancient techniques that have long since perished from the world.";
BeltItem::AddWeapon("Ancient Sword", "AncientSword", "GoliathSword", $SwordAccessoryType, $description, $SkillSwords, $SkillSwords @ " 820", "105", 23);
